...
import { MIBO } from "../../widgets/Navbar/icons";
...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <Container>
      <FlexContainer>
        <LogoFlex>
          {/*<MIBO width="240px" mb="20px" />*/}
          <Text color="primaryBright" size="16px">
            {t(
              `MIBO is a Platform DeFi Hub on FTM Chain focused on offering an accessible, transparent and secure experience for everyone.`
            )}
          </Text>
          <ButtonFlex>
          ...
          <IconFlex>
            <StyledLink href="https://twitter.com/MIBOCR" target="_blank" rel="noopener noreferrer">
              <TwitterIcon
                color="white3"
                fill={iconFillColor}
            ...
            <StyledLink href="https://discord.com/invite/MIBO" target="_blank" rel="noopener noreferrer">
              <DiscordIcon
                color="white3"
                fill={iconFillColor}
            ...
            */}
            <StyledLink href="https://mibo.medium.com/" target="_blank" rel="noopener noreferrer">
              <MediumIcon
                color="white3"
                fill={iconFillColor}
            ...
            <StyledLink href="https://www.instagram.com/mibo_cr/" target="_blank" rel="noopener noreferrer">
              <InstagramIcon
                color="white3"
                fill={iconFillColor}
                onClick={() =>
          ...
          <BottomRowContainer>
            ...
            <a href="https://apeswap.finance/swap" target="_blank" rel="noopener noreferrer">
              <BuyBananaButton>{t("BUY MIBO")}</BuyBananaButton>
            </a>
